...
/** Test class for {@link com.google.cloud.teleport.v2.io.WindowedFilenamePolicy}. */
...
public class WindowedFilenamePolicyTest {
  ...
  public void testWindowedFilenameFormatValueProvider() throws IOException {
    ...
    com.google.cloud.teleport.v2.io.WindowedFilenamePolicy policy =
        new com.google.cloud.teleport.v2.io.WindowedFilenamePolicy(outputDirectory.toString(),
            "output" ,"-SSS-of-NNN", ".txt");
  ...
  public void testUnwindowedFilenameFails() {
    ...
    com.google.cloud.teleport.v2.io.WindowedFilenamePolicy policy =
        new com.google.cloud.teleport.v2.io.WindowedFilenamePolicy(null,
            "string-output", "-SSS-of-NNN", ".csv");
